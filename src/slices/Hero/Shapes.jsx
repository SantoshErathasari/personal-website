...
function Geometries(){
    const geometries = [
        {
            position: [0, 0, 0],
            r: 0.3, 
            geometry: new Three.IcosahedronGeometry(3), //topright
    ...
    return geometries.map(({position, r, geometry})=>(
        <Geometry key={JSON.stringify(position)} position={position.map((p)=>p*2)} geometry ={geometry} materials ={materials} r={r}></Geometry>
    ));
